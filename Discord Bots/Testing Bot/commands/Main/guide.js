...
exports.run = async (client, message, args) => {
  ...
  function embeds(member, number){
    let listofnames = [' ','Leveling System!','Economy System!','ModLog System!','Music System!','Welcome System!', 'GoodBye System!','Moderation Commands!','Image Manipulcations!','Anime Emotions!','Fun Commands!','Speical Commands!','Server Stats!']
