...
module.exports.run = async (client, message, args) => {
  ...
  if (message.mentions.users.first()) {
    ...
    let attachment = new Discord.MessageAttachment(image, "effect.png");
...
exports.help = {
  name: "effect",
  description: "effect user avatar",
  usage: "effect [@user | user ID]",
  example: "effect @BurnKnuckle \neffect"
}
