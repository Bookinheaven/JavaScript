...
exports.help = {
  name: "facepalm",
  description: "facepalm user avatar",
  usage: "facepalm [@user | user ID]",
  example: "facepalm @BurnKnuckle \nfacepalm"
}
