...
exports.help = {
  name: "greyscale",
  description: "greyscale user avatar",
  usage: "greyscale [@user | user ID]",
  example: "greyscale @BurnKnuckle \ngreyscale"
}
